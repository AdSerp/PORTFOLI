...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const experiencias = [
      { href: 'https://www.adecco.es/', imgSrc: './assets/adecco.png', alt: 'adecco', descripcion: 'Me encargaba tanto de el mantenimiento y producción de webs para terceros, como de la atención a peticiones especiales de estos.' },
      ...
      { href: 'https://www.pentaweb.es/', imgSrc: './assets/pentaweb.jpg', alt: 'pentaweb', descripcion: 'Me encargaba del  diseño de tiends online, implementando catálogos de productos totalmente clasificados y organizados por categorias.' },
      ...
      { href: 'https://www.fxstreet.es/', imgSrc: './assets/fxstreet.jpg', alt: 'fxstreet', descripcion: 'Responsable de maquetación de cero y mantenimiento  de la página, la cual se encarga de dar noticias actualizadas del comercio internacional y la economía.' }
    ];
